...
export const setSelectedStatistic = data => ({
  type: SET_SELECTED_STATISTIC,
  payload: data
});
export const setSearchedStr = data => ({
  type: SET_SEARCHED_STR,
  payload: data
});
export const setSearchedStrForStatistic = data => ({
  type: SET_SEARCHED_STR_FOR_STATISTIC,
  payload: data
});
export const setSortedType = data => ({ type: SET_SORTED_TYPE, payload: data });
export const setSortedTypeForStatistic = data => ({
  type: SET_SORTED_TYPE_FOR_STATISTIC,
  payload: data
});
export const setIsTestStarted = data => ({
  type: SET_IS_TEST_STARTED,
  payload: data
});
export const setIsTestEnded = data => ({
  type: SET_IS_TEST_ENDED,
  payload: data
});
...
export const setAnswerCollector = data => ({
  type: SET_ANSWER_COLLECTOR,
  payload: data
});
export const resetAnswerCollector = () => ({ type: RESET_ANSWER_COLLECTOR });
export const setCompletedTests = data => ({
  type: SET_COMPLETED_TESTS,
  payload: data
});
export const setSliderTranslateValue = data => ({
  type: SET_SLIDER_TRANSLATE_VALUE,
  payload: data
});
